...
| [#295](https://github.com/cfornesa/ai-dev-tools-zoomcamp-1/issues/295) | Live 3D five-slide hand-gesture guide | Shared capability; portable guide remains in #337 | `local_implementation_verified` | Dedicated disposable-stack browser scenario passes 1/1 for all five named slides and no camera permission on open; QA FAIL posted because exact published `/p3d/:id` evidence is still unavailable |
