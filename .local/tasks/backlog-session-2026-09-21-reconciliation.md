...
- **#721 engineering/QA:** implementation landed as `2a11de3`; Create/Gallery/Templates now use `Create a new 2D project` and the responsive `.page-shell` spacing contract. Focused Create/Gallery/Templates tests passed `31`; frontend typecheck, lint (pre-existing warnings), and Prettier checks passed. Deployment remains pending owner Replit access.
