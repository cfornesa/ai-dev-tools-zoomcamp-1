    ...
    <div role="group" aria-label="Authored sound defaults" className="editor-sound-defaults-panel">
      <fieldset>
        ...
        <label>
          Ambient volume
          <input
            id="project3d-sonic-ambient-volume"
            type="range"
            min={0}
            max={100}
            value={current.extras.ambient_volume ?? current.extras.default_volume}
            onChange={(e) => updateExtras({ ambient_volume: Number(e.target.value) })}
          />
      ...
      <fieldset>
        ...
        <label>
          <input
            id="project3d-sonic-follow-key"
            type="checkbox"
            checked={current.follow_key}
            onChange={(e) => update({ follow_key: e.target.checked })}
          />
        ...
        <label>
          ...
          <input
            ...
            min={0}
            max={100}
            value={current.extras.keyboard_volume ?? current.extras.default_volume}
            onChange={(e) => updateExtras({ keyboard_volume: Number(e.target.value) })}
          />
          <span>{current.extras.default_volume}%</span>
        </label>
        <label>
