/** Issue #387: verify the anonymous regular 3D embed route independently. */
...
test.describe('anonymous regular 3D embed stage chrome', () => {
  ...
  test('keeps the chrome-less embed proportional and exposes public controls', async ({
    page,
    browser,
  }) => {
    ...
    try {
      ...
      for (const viewport of [
        ...
        await test.info().attach(`3d-embed-${viewport.name}`, {
