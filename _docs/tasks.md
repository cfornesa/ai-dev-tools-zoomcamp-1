...
Next action: Rework explicit layer/shape selection state so layer activation selects its associated selectable shape and shape activation marks the complete owning-layer block selected, then add focused and real-browser regressions.
