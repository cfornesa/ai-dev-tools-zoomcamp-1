...
`docs/plan.md`'s "AI actions" section: "Edit scene: prompt + current
...
`test`. `docs/plan.md` calls for a "minimal structured patch"; three
...
- `/randomness/seed` -- `docs/plan.md`'s "Visual randomness" section:
