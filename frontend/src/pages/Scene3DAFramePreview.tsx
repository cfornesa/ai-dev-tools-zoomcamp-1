...
export default function Scene3DAFramePreview({
  ...
  const srcDoc = useMemo(
    () => buildArtPieceSandboxDocument(buildAFrameSceneMarkup(scene), 'aframe', 'regular'),
    [scene],
  );
  ...
  return (
    ...
    >
      <div className="scene3d-preview-canvas-frame" data-testid="scene3d-preview-canvas-frame">
        <iframe
          ref={iframeRef}
