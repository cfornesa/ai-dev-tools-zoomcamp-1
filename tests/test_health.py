"""PostgreSQL-backed tests for `config.views.database_is_available`.
...
environment variable (see `config/test_settings.py`) and skip themselves
...
from config.views import database_is_available
