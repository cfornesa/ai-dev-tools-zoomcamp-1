...
`docs/plan.md`'s "API-key security" section: "Keep provider API keys
...
This mirrors `backend.settings.get_required_env`'s fail-fast convention
...
# (see AGENTS.md and backend/backend/settings.py).
