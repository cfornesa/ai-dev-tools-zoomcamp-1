...
export default function CanonicalPublicPiece() {
  ...
  if (resolved.type === '2d' && resolved.piece) {
    return <PublicProjectViewer initialProject={resolved.piece as PublicProject} />;
  }
  if (resolved.type === '3d' && resolved.piece) {
    return <PublicProject3DViewer initialProject={resolved.piece as PublicProject3D} />;
  }
